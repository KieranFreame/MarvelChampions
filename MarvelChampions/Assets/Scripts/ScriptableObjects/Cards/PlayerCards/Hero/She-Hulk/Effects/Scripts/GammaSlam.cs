...
public class GammaSlam : PlayerCardEffect
{
    ...
    public override async Task OnEnterPlay()
    {
        ...
        await _owner.CharStats.InitiateAttack(new(damage, new List<TargetType>() { TargetType.TargetVillain, TargetType.TargetMinion }, AttackType.Card, owner: _owner, card: Card));
    }
}
