...
public class MagicBlast : PlayerCardEffect
{
    ...
    public override async Task OnEnterPlay()
    {
        ...
        await _owner.CharStats.InitiateAttack(new(5, targets: new() { TargetType.TargetVillain, TargetType.TargetMinion }, attackType: AttackType.Card, owner:_owner, card:Card));
