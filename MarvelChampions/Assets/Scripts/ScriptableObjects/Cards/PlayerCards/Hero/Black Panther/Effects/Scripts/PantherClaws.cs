...
public class PantherClaws : PlayerCardEffect, IBlackPanther
{
    ...
    {
        await _owner.CharStats.InitiateAttack(new(last ? 4 : 2, targets: new() { TargetType.TargetVillain, TargetType.TargetMinion }, attackType: AttackType.Card, owner:_owner, card: Card));
    }
}
